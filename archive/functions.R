#############################################################################################################################################################################
## PRIMARY FUNCTIONS FOR MODEL FITTING
## Trying to be as flexible as possible and use svyglm when needed
## Also includes possibility of age/time-specific models for repeated time-varying mediators vs. pooled models
#############################################################################################################################################################################
...
#############################################################################################################################################################################
## PRIMARY FUNCTIONS FOR G-FORMULA SIMULATIONS
## Parallelization is currently written for Windows OS, as restricted Add Health data were stored on Windows server. Could rewrite with mclapply() for Linux.
#############################################################################################################################################################################
